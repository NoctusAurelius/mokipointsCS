            ...
            <div class="header-content">
                ...
                <div class="user-info">
                    <div class="nav-links" style="display: flex; gap: 20px; align-items: center; margin-right: 20px;">
                        ...
                        <a href="RewardShop.aspx" class="active" style="color: #0066CC; text-decoration: none; font-weight: 500; font-size: 16px;">Shop</a>
                        ...
                        <ItemTemplate>
                            <div id="rewardCard" runat="server" class="reward-card" data-category='<%# Eval("Category") ?? "" %>'>
                                ...
                                <div class="reward-meta">
                                    ...
                                    <asp:Literal ID="litOutOfStockBadge" runat="server"></asp:Literal>
                                </div>
